...
function App() {
  const [url, setUrl] = reactExports.useState(HOME_URL);
  const [currentUrl, setCurrentUrl] = reactExports.useState(HOME_URL);
  const [showQuickBar, setShowQuickBar] = reactExports.useState(false);
  const [opacity, setOpacity] = reactExports.useState(1);
  const [onTop, setOnTop] = reactExports.useState(false);
  const webviewRef = reactExports.useRef(null);
  const webviewContainerRef = reactExports.useRef(null);
  const quickInputRef = reactExports.useRef(null);
  const loadInWebview = (targetUrl) => {
  ...
  reactExports.useEffect(() => {
    ...
    wv.style.cssText = "position:absolute;inset:0;border:0;display:flex;background:#fff;";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    showQuickBar && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quick-bar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quick-row", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "quick-btn", onClick: () => goUrl(), children: "前往" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "quick-btn close", onClick: () => setShowQuickBar(false), title: "关闭 (ESC)", children: "✕" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quick-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "quick-label", children: "透明度" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "quick-value", children: [
          Math.round(opacity * 100),
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: `quick-toggle ${onTop ? "on" : ""}`,
          onClick: () => setOnTop((v) => !v),
          title: "切换置顶 (⌘T)",
          children: onTop ? "📌 已置顶" : "📍 未置顶"
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "webview-container", ref: webviewContainerRef }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "titlebar",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        title: "拖动窗口",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "handle-grip", children: "⠿" })
      }
    )
  ] });
}
